...
STAR7="$HOMEA/usr/lib/x86_64-linux-gnu/blis-openmp:$HOMEA/usr/lib/x86_64-linux-gnu/atlas:$HOMEA/usr/lib/x86_64-li
nux-gnu/tracker-miners-2.0:$HOMEA/usr/lib/x86_64-linux-gnu/tracker-2.0:$HOMEA/usr/lib/x86_64-linux-gnu/lapack:$HOMEA/usr/lib/x86_64-linux-gnu/gedit"
...
${bold}${lightblue}@@    @   @@  @@            !!  !                   ~ o           o 
${bold}${lightblue}@@   @        @@ @        ! !!   !                 ~  0 o        o 0
${bold}${lightblue}@@  @     @@  @@  @     !   !!    !               ~   o  o      o  0    
${bold}${lightblue}@@ @      @@  @@    @ !     !!      !            ~    o    o  o    0    
${bold}${lightblue}@@@       @@  @@     @      !!       !           ~    o      o     0      
${bold}${lightblue}@@ @      @@  @@            !!        ~        ~      o            0     
${bold}${lightblue}@@  @     @@  @@            !!          ~      ~      o            0   
${bold}${lightblue}@@   @    @@  @@            !1           ~    ~       o            0           
${bold}${lightblue}@@    @   @@  @@            !!            ~  ~        o            0       
${bold}${lightblue}@@     @  @@  @@            !!              ~         o            0   
...
if [[ -f "./installed" ]]; then
    echo "${bold}${lightgreen}==> Started ${lightblue}KIMVM${lightgreen} <=="
    function runcmd1 {
        printf "${bold}${lightgreen}User${nc}@${lightblue}Kim-vm${nc}:~ "
        read -r cmdtorun
    ...
    echo "Downloading files for KIMVM"
    ...
    echo -ne '##                  (10%)\r'
    curl -sSLo unzip https://raw.githubusercontent.com/afnan007a/Kim-vm/main/unzip >/dev/null 2>err.log
    echo -ne '####                (20%)\r'
